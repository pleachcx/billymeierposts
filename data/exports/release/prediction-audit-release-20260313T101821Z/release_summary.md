...
- Generated at: `2026-03-13T10:18:21.561589+00:00`
...
- Included scored rows: `145`
- Hits: `134` (`105` exact, `20` near, `9` similar-only)
- Misses: `11`
- Combined observed log10 probability sum: `-225.207105`
...
| pending evidence | 29 | 27 | 23 | 2 | -40.022334 |
| publication conflicts | 106 | 106 | 81 | 0 | -171.790841 |
...
- Research queue rows: `106`. Current aligned export: `data/exports/provenance/public-date-research-queue-20260313T101813Z`
- Unscored queue rows: `1877`. Current aligned export: `data/exports/unscored/unscored-prediction-queue-20260313T101814Z`

| Rank | Report/Candidate | Family | Stage 2 Label | Recovery Bucket |
| --- | --- | --- | --- | --- |
| 1 | 136/251 | war_conflict | significant_prediction | promote_via_existing_family_pipeline |
| 2 | 182/57 | war_conflict | significant_prediction | promote_via_existing_family_pipeline |
| 3 | 201/12 | war_conflict | significant_prediction | promote_via_existing_family_pipeline |
| 4 | 216/33 | war_conflict | significant_prediction | promote_via_existing_family_pipeline |
| 5 | 231/4 | war_conflict | significant_prediction | promote_via_existing_family_pipeline |
| 6 | 231/5 | war_conflict | significant_prediction | promote_via_existing_family_pipeline |
| 7 | 238/20 | storm | significant_prediction | promote_via_existing_family_pipeline |
| 8 | 238/68 | war_conflict | significant_prediction | promote_via_existing_family_pipeline |
| 9 | 238/85 | politics_election | significant_prediction | promote_via_existing_family_pipeline |
| 10 | 238/182 | politics_election | significant_prediction | promote_via_existing_family_pipeline |
| 11 | 238/186 | politics_election | significant_prediction | promote_via_existing_family_pipeline |
| 12 | 238/195 | politics_election | significant_prediction | promote_via_existing_family_pipeline |
| 13 | 241/12 | epidemic | significant_prediction | promote_via_existing_family_pipeline |
| 14 | 241/16 | war_conflict | significant_prediction | promote_via_existing_family_pipeline |
| 15 | 252/2 | politics_election | significant_prediction | promote_via_existing_family_pipeline |

## Source Exports

- `overview`: `data/exports/overview/prediction-audit-overview-20260313T101813Z`
- `publication_timing`: `data/exports/provenance/publication-timing-audit-20260313T101813Z`
- `cohort_comparison`: `data/exports/provenance/cohort-comparison-20260313T101813Z`
- `research_queue`: `data/exports/provenance/public-date-research-queue-20260313T101813Z`
- `unscored_queue`: `data/exports/unscored/unscored-prediction-queue-20260313T101814Z`
...
- `family/war_conflict`: `data/exports/war_conflict/stage4-war-conflict-20260313T101724Z`
