...
SCRIPT_VERSION = "stage7_aviation_space_final_v2"
REVIEWER = "script:stage7_aviation_space_final_v2"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--adjudications-path",
        default=str(REPO_ROOT / "data" / "aviation_space_final_adjudications.json"),
        help="Path to aviation-space final adjudication JSON keyed by report_number:candidate_seq.",
    )
...
def decide_final_status(prediction: dict[str, Any], adjudications: dict[str, dict[str, Any]]) -> tuple[str, str, dict[str, Any]]:
    ...
    raise RuntimeError(f"Missing aviation-space final adjudication rule for unresolved prediction {key}.")
