...
baseline_stage2_run_key: stage2-20260311T093233Z
baseline_exports:
  overview: data/exports/overview/prediction-audit-overview-20260312T031911Z/summary.json
  publication_timing: data/exports/provenance/publication-timing-audit-20260312T031910Z/summary.json
  cohort_comparison: data/exports/provenance/cohort-comparison-20260312T031910Z/summary.json
  research_queue: data/exports/provenance/public-date-research-queue-20260312T031910Z/summary.json
current_state:
  candidate_count: 6618
  eligible_count: 1157
  significant_count: 294
  included_scored_count: 100
  claimed_hit_count: 93
  claimed_exact_hit_count: 68
  public_date_clean_count: 8
  public_date_clean_exact_hit_count: 1
  public_date_currently_unrescued_count: 92
  family_counts:
    aviation_space: 1
    earthquake: 54
    epidemic: 12
    politics_election: 14
    storm: 6
    volcano: 13
global_assumptions:
  - The prediction audit remains anchored to the fresh parse tables and ignores legacy JSON prediction fields.
  - The current aligned mainline baseline is stage2-20260311T093233Z unless a pack explicitly reruns Stage 1 or Stage 2.
...
packs:
  ...
  - pack_id: P5
    ...
    commit_strategy: Keep report script and generated outputs together in one coherent commit.
    slices:
      - slice_id: P5.S1
        ...
        allowed_files:
          ...
          - docs/agent_notes.md
        validators:
          - python3 scripts/export_prediction_audit_release_report.py --stage2-run-key stage2-20260311T093233Z
        stop_conditions:
      ...
      - slice_id: P5.S2
        ...
        allowed_files:
          ...
          - docs/agent_notes.md
        validators:
          - rg -n "prediction audit|public-date|release report|stage2-20260311T093233Z" README.md docs/prediction_audit_supervisor_work_spec.md
        stop_conditions:
...
- Current aligned Stage 2 baseline: `stage2-20260311T093233Z`
- Current scored set: `100` predictions
- Claimed-date hits: `93`
- Claimed-date exact hits: `68`
- Current public-date-clean cohort: `8`
- Current public-date-clean exact hits: `1`
- Current public-date-currently-unrescued cohort: `92`
