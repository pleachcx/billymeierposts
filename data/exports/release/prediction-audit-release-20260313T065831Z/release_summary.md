...
- Generated at: `2026-03-13T06:58:31.051009+00:00`
...
- Included scored rows: `134`
- Hits: `108` (`80` exact, `18` near, `10` similar-only)
- Misses: `26`
- Combined observed log10 probability sum: `-173.585868`

## Public-Date Separation

| Cohort | Rows | Hits | Exact | Misses | log10(sum p_obs) |
| --- | --- | --- | --- | --- | --- |
| public-date clean | 20 | 1 | 1 | 19 | -14.109957 |
| pending evidence | 28 | 21 | 15 | 7 | -26.3179 |
| publication conflicts | 86 | 86 | 64 | 0 | -133.158012 |
...
| epidemic | 23 | 14 | 4 | 1 | 9 | 10 |
| politics_election | 27 | 18 | 7 | 0 | 1 | 19 |
| storm | 7 | 6 | 1 | 0 | 0 | 6 |
| volcano | 24 | 14 | 3 | 0 | 8 | 13 |
...
- Research queue rows: `86`. Current aligned export: `data/exports/provenance/public-date-research-queue-20260313T065749Z`
- Unscored queue rows: `1603`. Current aligned export: `data/exports/unscored/unscored-prediction-queue-20260313T065830Z`

| Rank | Report/Candidate | Family | Stage 2 Label | Recovery Bucket |
| --- | --- | --- | --- | --- |
| 1 | 202/5 | aviation_space | significant_prediction | promote_via_existing_family_pipeline |
...
| 6 | 252/2 | politics_election | significant_prediction | promote_via_existing_family_pipeline |
| 7 | 258/11 | aviation_space | significant_prediction | promote_via_existing_family_pipeline |
| 8 | 366/27 | aviation_space | significant_prediction | promote_via_existing_family_pipeline |
| 9 | 383/5 | politics_election | significant_prediction | promote_via_existing_family_pipeline |
| 10 | 481/4 | aviation_space | significant_prediction | promote_via_existing_family_pipeline |
| 11 | 537/3 | aviation_space | significant_prediction | promote_via_existing_family_pipeline |
| 12 | 589/4 | politics_election | significant_prediction | promote_via_existing_family_pipeline |
| 13 | 687/12 | politics_election | significant_prediction | promote_via_existing_family_pipeline |
| 14 | 688/25 | aviation_space | significant_prediction | promote_via_existing_family_pipeline |
| 15 | 718/25 | politics_election | significant_prediction | promote_via_existing_family_pipeline |

## Source Exports

- `overview`: `data/exports/overview/prediction-audit-overview-20260313T065830Z`
- `publication_timing`: `data/exports/provenance/publication-timing-audit-20260313T065749Z`
- `cohort_comparison`: `data/exports/provenance/cohort-comparison-20260313T065749Z`
- `research_queue`: `data/exports/provenance/public-date-research-queue-20260313T065749Z`
- `unscored_queue`: `data/exports/unscored/unscored-prediction-queue-20260313T065830Z`
...
- `family/epidemic`: `data/exports/epidemic/stage4-epidemic-20260313T065806Z`
- `family/politics_election`: `data/exports/politics/stage4-politics-20260313T065744Z`
- `family/storm`: `data/exports/storm/stage4-storm-20260313T065807Z`
- `family/volcano`: `data/exports/volcano/stage4-volcano-20260313T065549Z`
