...
SCRIPT_VERSION = "stage7_politics_final_v1"
REVIEWER = "script:stage7_politics_final_v1"
...
def decide_final_status(prediction: dict[str, Any]) -> tuple[str, str, dict[str, Any]]:
    ...
    return (
        ...
        "Prediction remains unresolved in the current politics slice and is excluded until a defensible rulebook exists.",
        {
            "script_version": SCRIPT_VERSION,
            "reason_code": "unresolved_politics_slice",
        },
    )
